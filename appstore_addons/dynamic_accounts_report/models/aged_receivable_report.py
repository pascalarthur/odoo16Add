    ...
    def view_report(self):
        ...
        for partner_id in partner_ids:
            ...
            move_line_data = move_line_ids.read([
                'name', 'move_name', 'date', 'amount_currency', 'account_id', 'date_maturity', 'currency_id', 'debit',
                'move_id'
            ])
        ...
        if data:
            if report_name == 'Aged Receivable':
                ...
                for move_line in data['move_lines']:
                    ...
                    sheet.write(row, col + 14, data['total'][move_line]['debit_sum'], txt_name)
                ...
                sheet.write(row + 1, col + 14, data['grand_total']['total_debit'], filter_head)
