    ...
    def process(self):
        for payment in self.payment_ids:
            self.env['account.bank.statement.line'].create({
                ...
                'amount':
                payment.payment_type == 'inbound' and payment.amount or -payment.amount,
        ...
        for line in self.move_line_ids:
            amount_residual = line.currency_id._convert(line.amount_residual_currency, self.statement_id.currency_id,
            ...
            self.env['account.bank.statement.line'].create({
                ...
                line.move_id.ref,
                'amount':
                self.statement_id.currency_id.round(amount_residual),
