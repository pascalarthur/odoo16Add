...
export class AccountReconcileDataWidget extends Component {
    ...
    getReconcileLines() {
        ...
        for (var line in data) {
            data[line].amount_format = this.env.utils.formatCurrency(
                data[line].amount,
                undefined,
                {
            ...
            data[line].debit_format = this.env.utils.formatCurrency(
                data[line].debit,
                undefined,
                {
                    currency: session.get_currency(data[line].currency_id),
            ...
            data[line].credit_format = this.env.utils.formatCurrency(
                data[line].credit,
                undefined,
                {
                    currency: session.get_currency(data[line].currency_id),
            ...
            data[line].amount_currency_format = this.env.utils.formatCurrency(
            ...
            if (data[line].original_amount) {
                data[line].original_amount_format = this.env.utils.formatCurrency(
