...
class AccountFinancialReport(models.Model):
    ...
    type = fields.Selection([('sum', 'View'), ('accounts', 'Accounts'), ('account_type', 'Account Type'),
    ...
    account_type_ids = fields.Selection(
        ...
        ], string="Type", help="These types are defined according to your country. "
    ...
    sign = fields.Selection([("-1", 'Reverse balance sign'), ("1", 'Preserve balance sign')], 'Sign on Reports',
                            required=True, default="1", help='For accounts that are typically more'
    ...
    display_detail = fields.Selection([('no_detail', 'No detail'), ('detail_flat', 'Display children flat'),
                                       ('detail_with_hierarchy', 'Display children with hierarchy')], 'Display details',
                                      default='detail_flat')
    style_overwrite = fields.Selection([('0', 'Automatic formatting'), ('1', 'Main Title 1 (bold, underlined)'),
                                        ('2', 'Title 2 (bold)'), ('3', 'Title 3 (bold, smaller)'), ('4', 'Normal Text'),
                                        ('5', 'Italic Text (smaller)'),
                                        ('6', 'Smallest Text')], 'Financial Report Style', default='0',
