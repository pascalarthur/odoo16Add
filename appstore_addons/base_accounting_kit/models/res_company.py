...
class ResCompany(models.Model):
    ...
    def _validate_fiscalyear_lock(self, values):
        if values.get('fiscalyear_lock_date'):
            draft_entries = self.env['account.move'].search([('company_id', 'in', self.ids), ('state', '=', 'draft'),
            ...
            if unreconciled_statement_lines:
                error_msg = _("There are still unreconciled bank statement lines in the "
                ...
                raise RedirectWarning(error_msg, action_error, _('Show Unreconciled Bank'
                                                                 ' Statement Line'))
