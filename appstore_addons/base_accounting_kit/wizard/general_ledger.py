...
class AccountReportGeneralLedger(models.TransientModel):
    ...
    section_main_report_ids = fields.Many2many(string="Section Of", comodel_name='account.report',
                                               relation="account_report_general_section_rel", column1="sub_report_id",
                                               column2="main_report_id")
    section_report_ids = fields.Many2many(string="Sections", comodel_name='account.report',
                                          relation="account_report_general_section_rel", column1="main_report_id",
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('base_accounting_kit.action_report_general_ledger').with_context(
