...
class AccountBalanceReport(models.TransientModel):
    ...
    section_report_ids = fields.Many2many(string="Sections", comodel_name='account.report',
                                          relation="account_balance_report_section_rel", column1="main_report_id",
                                          column2="sub_report_id")
    section_main_report_ids = fields.Many2many(string="Section Of", comodel_name='account.report',
                                               relation="account_balance_report_section_rel", column1="sub_report_id",
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('base_accounting_kit.action_report_trial_balance').report_action(records, data=data)
