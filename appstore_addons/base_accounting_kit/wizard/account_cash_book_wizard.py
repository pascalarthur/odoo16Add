...
class CashBookWizard(models.TransientModel):
    ...
    journal_ids = fields.Many2many('account.journal', 'account_report_cashbook_journal_rel', 'account_id', 'journal_id',
    ...
    def check_report(self):
        ...
        return self.env.ref('base_accounting_kit.action_report_cash_book').report_action(self, data=data)
