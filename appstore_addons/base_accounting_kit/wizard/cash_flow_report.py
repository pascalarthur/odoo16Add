...
class AccountingReport(models.TransientModel):
    ...
    section_main_report_ids = fields.Many2many(string="Section Of", comodel_name='account.report',
                                               relation="account_cash_flow_report_section_rel", column1="sub_report_id",
                                               column2="main_report_id")
    section_report_ids = fields.Many2many(string="Sections", comodel_name='account.report',
                                          relation="account_cash_flow_report_section_rel", column1="main_report_id",
    ...
    label_filter = fields.Char(
        string='Column Label', help="This label will be displayed on report "
        "to show the balance"
    ...
    debit_credit = fields.Boolean(
        string='Display Debit/Credit Columns', help="This option allows you to get more "
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('base_accounting_kit.action_report_cash_flow').report_action(self, data=data, config=False)
