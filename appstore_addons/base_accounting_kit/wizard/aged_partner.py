...
class AccountAgedTrialBalance(models.TransientModel):
    ...
    section_report_ids = fields.Many2many(string="Sections", comodel_name='account.report',
                                          relation="account_aged_trail_report_section_rel", column1="main_report_id",
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('base_accounting_kit.action_report_aged_partner_balance').with_context(
