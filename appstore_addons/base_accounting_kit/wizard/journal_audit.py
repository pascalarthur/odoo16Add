...
class AccountPrintJournal(models.TransientModel):
    ...
    section_report_ids = fields.Many2many(string="Sections", comodel_name='account.report',
                                          relation="account_common_print_report_section_rel", column1="main_report_id",
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('base_accounting_kit.action_report_journal').with_context(landscape=True).report_action(
            self, data=data)
